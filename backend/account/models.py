...
class UserManager(BaseUserManager):
    ...
    def _create_user(self, *, phone_number=None, email=None, password=None, name="", auth_provider="local", **extra_fields):
    ...
    def create_user(self, *, phone_number=None, email=None, password=None, name="", auth_provider="local", **extra_fields):
        extra_fields.setdefault("is_staff", False)
        extra_fields.setdefault("is_superuser", False)
        return self._create_user(phone_number=phone_number, email=email, password=password, name=name, auth_provider=auth_provider, **extra_fields) 
    

    def create_superuser(self, *, phone_number=None, email=None, password=None, name="Admin", auth_provider="local", **extra_fields):  
        ...
        return self._create_user(phone_number=phone_number, email=email, password=password, name=name, auth_provider="local", **extra_fields)
...
class AuthAttempting(models.Model):
